 ...
 * $Revision: 1.2 $
 * $Date: 2004/08/13 23:32:37 $
 * $Author: Spearhawk $
 *
 *  Header file for player information
 *
 * $Log: Player.h,v $
 * Revision 1.2  2004/08/13 23:32:37  Spearhawk
 * Changed TARGET_WARPOUT_SPEED to 60.0f
 *
 * Revision 1.1.1.1  2004/08/13 22:47:43  Spearhawk
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 21:58:25  Darkhill
 * no message
 *
...
#define MAX_KEYED_TARGETS			4		// number of hot keys available to assign targets to
...
#define PLAYER_FLAGS_IS_TC_PILOT			(1<<19) // special stuff might happen if this pilot is from TC database
...
typedef struct player {
	...
	//char			quote[MAX_QUOTE_LENGTH+1];				// quote from TC database
	...
	int				tc_pilot;							// is this a TC pilot
	...
	int				update_dumbfire_big_time;				// when to update dumbfire for big ships
...
#define TARGET_WARPOUT_SPEED 60.0f		// speed you need to be going to warpout
#define TARGET_WARPOUT_MATCH_PERCENT 0.05f	// how close to TARGET_WARPOUT_SPEED you need to be
#define MINIMUM_PLAYER_WARPOUT_TIME	2.0f		// How long before you can press 'ESC' to abort warpout
