 ...
 * $Revision: 1.2 $
 * $Date: 2004/09/07 22:57:06 $
 * $Author: Darkhill $
 *
 * $Log: missionscreencommon.cpp,v $
 * Revision 1.2  2004/09/07 22:57:06  Darkhill
 ...
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 22:01:12  Darkhill
 * no message
 *
...
brief_common_buttons Common_buttons[3][GR_NUM_RESOLUTIONS][NUM_COMMON_BUTTONS] = {	
	{	// Main briefing
		{ // GR_640
			brief_common_buttons("BRB_30",		546,	428,	37,		7,		0), 
			brief_common_buttons("BRB_02",		315,	420,	37,		23,		1),
			brief_common_buttons("BRB_03",		370,	420,	37,		39,		2),
			brief_common_buttons("BRB_01",		565,	420,	37,		39,		5),
			brief_common_buttons("BRB_30",		533,	425,	500,	440,	6),
			brief_common_buttons("BRB_30",		533,	455,	479,	464,	7),	
			brief_common_buttons("BRB_30",		375,375,	-1,		-1,		39),
		}, 
		{ // GR_1024			
	...
	{	// UGH   ship selection
		{ // GR_640
			brief_common_buttons("CB_00",			375,320,		37,	7,		0),
			brief_common_buttons("CB_01",			430,320,	37,	23,	1),
			brief_common_buttons("CB_02",			485,320,	37,	39,	2),
			brief_common_buttons("CB_05",			540,375,	572,	413,	5),
			brief_common_buttons("CB_06",			485,375,	500,	440,	6),
			brief_common_buttons("CB_07",			430,375,	479,	464,	7),	
			brief_common_buttons("ssb_39",			375,375,	-1,		-1,		39),
		}, 
		{ // GR_1024			
			brief_common_buttons("2_CB_00",		12,	5,		59,	12,	0),
			brief_common_buttons("2_CB_01",		12,	31,	59,	37,	1),
...
#define NUM_COMMON_TEXT 7

UI_XSTR brief_common_text[3][GR_NUM_RESOLUTIONS][NUM_COMMON_TEXT] = {
	{ // briefing
		{ // GR_640
			{ "",			-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][0][COMMON_BRIEFING_REGION].button },
			{ "Ships",		-1,		322,	441,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][0][COMMON_SS_REGION].button },
			{ "Weapons",	-1,		365,	441,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][0][COMMON_WEAPON_REGION].button },
			{ "Commit",		-1,		567,	441,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][0][COMMON_COMMIT_REGION].button },
			{ "",			-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][0][COMMON_HELP_REGION].button },
			{ "",			-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][0][COMMON_OPTIONS_REGION].button },
			{ "",			-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][0][COMMON_RESET_REGION].button },
		},
		{ // GR_1024
			{ "",			-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][1][COMMON_BRIEFING_REGION].button },
			{ "Ships",		-1,		322,	441,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][1][COMMON_SS_REGION].button },
			{ "Weapons",	-1,		369,	441,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][1][COMMON_WEAPON_REGION].button },
			{ "Commit",		-1,		567,	441,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][1][COMMON_COMMIT_REGION].button },
			{ "",			-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][1][COMMON_HELP_REGION].button },
			{ "",			-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][1][COMMON_OPTIONS_REGION].button },
			{ "",			-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Common_buttons[BRIEFING][1][COMMON_RESET_REGION].button },
		}
	},
	{ // ship selection
		{ // GR_640
			{ "Briefing",	-1,		375,	341,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][0][COMMON_BRIEFING_REGION].button },
			{ "Ships",		-1,		438,	341,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][0][COMMON_SS_REGION].button },
			{ "Weapons",	-1,		481,	341,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][0][COMMON_WEAPON_REGION].button },
			{ "Commit",		-1,		541,	397,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][0][COMMON_COMMIT_REGION].button },
			{ "Help",		-1,		495,	397,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][0][COMMON_HELP_REGION].button },
			{ "Options",	-1,		429,	397,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][0][COMMON_OPTIONS_REGION].button },
			{ "Reset",		-1,		380,	397,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][0][COMMON_RESET_REGION].button },
		},
		{ // GR_1024
			{ "Briefing",	-1,		375,	320,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][1][COMMON_BRIEFING_REGION].button },
			{ "Ships",		-1,		430,	320,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][1][COMMON_SS_REGION].button },
			{ "Weapons",	-1,		481,	341,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][1][COMMON_WEAPON_REGION].button },
			{ "Commit",		-1,		567,	441,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][1][COMMON_COMMIT_REGION].button },
			{ "Help",		-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][1][COMMON_HELP_REGION].button },
			{ "Options",	-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][1][COMMON_OPTIONS_REGION].button },
			{ "Reset",		-1,		380,	397,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[SHIP_SELECTION][1][COMMON_RESET_REGION].button },
		}
	},
	{ // weapon selection
		{ // GR_640
			{ "Briefing",	-1,		375,	341,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][0][COMMON_BRIEFING_REGION].button },
			{ "Ships",		-1,		438,	341,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][0][COMMON_SS_REGION].button },
			{ "Weapons",	-1,		481,	341,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][0][COMMON_WEAPON_REGION].button },
			{ "Commit",		-1,		541,	397,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][0][COMMON_COMMIT_REGION].button },
			{ "Help",		-1,		495,	397,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][0][COMMON_HELP_REGION].button },
			{ "Options",	-1,		429,	397,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][0][COMMON_OPTIONS_REGION].button },
			{ "Reset",		-1,		380,	397,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][0][COMMON_RESET_REGION].button },
		},
		{ // GR_1024
			{ "Briefing",	-1,		375,	320,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][1][COMMON_BRIEFING_REGION].button },
			{ "Ship",		-1,		430,	320,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][1][COMMON_SS_REGION].button },
			{ "Weapons",	-1,		485,	320,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][1][COMMON_WEAPON_REGION].button },
			{ "Commit",		-1,		567,	441,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][1][COMMON_COMMIT_REGION].button },
			{ "Help",		-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][1][COMMON_HELP_REGION].button },
			{ "Options",	-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][1][COMMON_OPTIONS_REGION].button },
			{ "Reset",		-1,		380,	397,	UI_XSTR_COLOR_GREEN, -1, &Common_buttons[WEAPON_SELECTION][1][COMMON_RESET_REGION].button },
		}
	}
};


extern void ss_reset_to_default();
...
void mission_common_force_button_frame(int screen)
{
	for (int x=0; x<NUM_COMMON_BUTTONS; x++) {
		if ( !Common_buttons[screen][gr_screen.res][x].button.button_down()) 
			// don't draw reset button if in multi
			if ((x == COMMON_RESET_BUTTON) && (Game_mode & GM_MULTIPLAYER))
				continue;
			Common_buttons[screen][gr_screen.res][x].button.draw_forced(1);
	}
}

void mission_common_maybe_show_button_text(int screen)
{
	brief_common_buttons *b;
	
	for (int i=0; i<NUM_COMMON_TEXT; i++) {
		b = &Common_buttons[screen][gr_screen.res][i];

		if (b->button.button_hilighted()) {
			gr_set_color_fast(&Color_bright_white);
			gr_string(brief_common_text[screen][gr_screen.res][i].x, brief_common_text[screen][gr_screen.res][i].y, brief_common_text[screen][gr_screen.res][i].xstr);
		}
	}
}
