 ...
 *
 * $Log: missioncmdbrief.cpp,v $
 * Revision 1.1.1.1  2004/08/13 22:47:42  Spearhawk
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 22:00:51  Darkhill
 * no message
 *
...
int Cmd_text_wnd_coords[NUM_CMD_SETTINGS][GR_NUM_RESOLUTIONS][4] = {
	...
	{
		{
			328,252, 304, 190//17, 109, 606, 108			// GR_640
		},
		{
...
int Cmd_image_wnd_coords[GR_NUM_RESOLUTIONS][4] = {
	{
		316,4, 320,240//26, 258, 441, 204				// GR_640
	},
	{
...
// text
#define CMD_BRIEF_NUM_TEXT		6
UI_XSTR Cmd_brief_text[GR_NUM_RESOLUTIONS][CMD_BRIEF_NUM_TEXT] = {
	{ // GR_640
		{ "Start",		1484,	328,	446,	UI_XSTR_COLOR_GREEN,	-1,	&Cmd_brief_buttons[0][CMD_BRIEF_BUTTON_FIRST_STAGE].button },
		{ "Last",		1485,	468,	446,	UI_XSTR_COLOR_GREEN,	-1,	&Cmd_brief_buttons[0][CMD_BRIEF_BUTTON_PREV_STAGE].button },
		{ "Pause",		1486,	380,	446,	UI_XSTR_COLOR_GREEN,	-1,	&Cmd_brief_buttons[0][CMD_BRIEF_BUTTON_PAUSE].button },
		{ "Next",		1487,	512,	446,	UI_XSTR_COLOR_GREEN,	-1,	&Cmd_brief_buttons[0][CMD_BRIEF_BUTTON_NEXT_STAGE].button },
		{ "End",		1488,	432,	446,	UI_XSTR_COLOR_GREEN,	-1,	&Cmd_brief_buttons[0][CMD_BRIEF_BUTTON_LAST_STAGE].button },
		{ "That is enough for now, sir",	1489,	328, 463, UI_XSTR_COLOR_GREEN,	-1,	&Cmd_brief_buttons[0][CMD_BRIEF_BUTTON_ACCEPT].button },
	},
	{ // GR_1024
		{ "Help",		1484,	800,	704,	UI_XSTR_COLOR_GREEN,	-1,	&Cmd_brief_buttons[1][CMD_BRIEF_BUTTON_HELP].button },
		{ "Options",	1485,	797,	743,	UI_XSTR_COLOR_GREEN,	-1,	&Cmd_brief_buttons[1][CMD_BRIEF_BUTTON_OPTIONS].button },
		{ "Continue",	1486,	917,	661,	UI_XSTR_COLOR_PINK,	-1,	&Cmd_brief_buttons[1][CMD_BRIEF_BUTTON_ACCEPT].button },
		{ "Start",		1487,	328,	446,	UI_XSTR_COLOR_GREEN,	-1,	&Cmd_brief_buttons[0][CMD_BRIEF_BUTTON_FIRST_STAGE].button },
		{ "Start",		1488,	328,	446,	UI_XSTR_COLOR_GREEN,	-1,	&Cmd_brief_buttons[0][CMD_BRIEF_BUTTON_FIRST_STAGE].button },
		{ "Pause",		1489,	380,	446,	UI_XSTR_COLOR_GREEN,	-1,	&Cmd_brief_buttons[0][CMD_BRIEF_BUTTON_PAUSE].button },
...
void cmd_brief_button_pressed(int n)
{
	switch (n) {
		case CMD_BRIEF_BUTTON_HELP:
			// hack, just using options button to quit commander briefing
