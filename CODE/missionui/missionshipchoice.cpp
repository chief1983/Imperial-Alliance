...
// Game-wide Globals
//////////////////////////////////////////////////////
char default_player_ship[255] = NOX("TIE Fighter");
...
static int Ship_anim_coords[GR_NUM_RESOLUTIONS][4] = {
	{
		253,43,628,298//257, 84		// GR_640
	},
	{
		412, 135, 628, 98	// GR_1024
	}
};
...
//				aps.start_at = 0;
	...
	if (Selected_ss_class >= 0 && ShipSelectModelNum >= 0)
	{
		...
		gr_set_clip(Ship_anim_coords[gr_screen.res][0], Ship_anim_coords[gr_screen.res][1], Ship_anim_coords[gr_screen.res][2], Ship_anim_coords[gr_screen.res][3]);		
