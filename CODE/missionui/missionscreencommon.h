...
#define COMMON_RESET_REGION							8
#define NUM_COMMON_REGIONS							7

#define NUM_COMMON_BUTTONS	7

#define BRIEFING							0
#define SHIP_SELECTION						1
#define WEAPON_SELECTION					2
...
// good stuff for buttons and text
void mission_common_force_button_frame(int screen);
