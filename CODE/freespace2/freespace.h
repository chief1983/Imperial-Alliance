 ...
 * $Revision: 1.2 $
 * $Date: 2004/09/07 22:57:04 $
 * $Author: Darkhill $
 *
 * FreeSpace, the game, not the project, header information.
 *
 * $Log: freespace.h,v $
 * Revision 1.2  2004/09/07 22:57:04  Darkhill
 ...
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 20:44:44  Darkhill
 * no message
 *
...
// filename extensions
#define FS_MISSION_FILE_EXT				NOX(".iam")
#define FS_CAMPAIGN_FILE_EXT				NOX(".iac")
