 ...
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 20:48:36  Darkhill
 * no message
 *
...
{
	float			shields, integrity, system;
	...
	if ( (sp->flags & SF_ENGINES_DISABLED) || (sp->flags2 & SF2_DISABLED) || (ship_subsys_disrupted(sp, SUBSYSTEM_ENGINE)) ) {		
	...
	// show ship integrity
	hud_get_target_strength(objp, &shields, &integrity, &system);
