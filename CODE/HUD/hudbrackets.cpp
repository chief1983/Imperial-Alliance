 ...
 *
 * $Log: hudbrackets.cpp,v $
 * Revision 1.1.1.1  2004/08/13 22:47:41  Spearhawk
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 20:48:29  Darkhill
 * no message
 *
...
int hud_brackets_get_iff_color(int iff)
{
	int color=IFF_COLOR_IMPERIAL; //IFF_COLOR_FRIENDLY;
...
{
	// if ship is cloaked don't want to draw the brackets	
	if (Ships[target_objnum].flags2 & SF2_CLOAK_ON)
		return;
