 ...
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 20:50:16  Darkhill
 * no message
 *
...
#define HUD_SOURCE_HOSTILE      1
#define HUD_SOURCE_FRIENDLY		2
#define HUD_SOURCE_BLUE			3
#define HUD_SOURCE_PURPLE		4
#define HUD_SOURCE_YELLOW		5
#define HUD_SOURCE_RED			6
#define HUD_SOURCE_ORANGE		7
#define HUD_SOURCE_TRAITOR		8
#define HUD_SOURCE_TRAINING		9
#define HUD_SOURCE_HIDDEN		10
#define HUD_SOURCE_IMPORTANT	11
#define HUD_SOURCE_FAILED		12
#define HUD_SOURCE_SATISFIED	13
#define HUD_SOURCE_TERRAN_CMD	14
#define HUD_SOURCE_NETPLAYER	15
