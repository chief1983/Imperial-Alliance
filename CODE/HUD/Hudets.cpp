 ...
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 20:49:38  Darkhill
 * no message
 *
...
{
	{ // GR_640
		'L', {587,143}, {586,101}, {586,151},  //{525,422}, {523,380}, {523,430}
		'S', {604,143}, {603,101}, {603,151},//{542,422}, {540,380}, {540,430}
		'E', {621,143}, {620,101}, {620,151},//{560,422}, {557,380}, {557,430}
	},
	{ // GR_1024
		'L', {882,690}, {880,648}, {880,698},
		'S', {900,690}, {898,648}, {898,698},
...
//	new_energy = fl_frametime * sinfo_p->power_output;
	...
	if ( y == Energy_levels[INTIAL_ENGINE_RECHARGE_INDEX] ){
		...
		if ( y < Energy_levels[INTIAL_ENGINE_RECHARGE_INDEX] ){
			...
			// bad hack, problems with modifying ship speeds based on LSE settings are here
...
void set_default_recharge_rates(object* obj)
{
	...
	switch ( ship_properties ) {
		...
		case HAS_ENGINES | HAS_WEAPONS:
			...
			//ship_p->weapon_recharge_index = INTIAL_WEAPON_RECHARGE_INDEX;
			//ship_p->engine_recharge_index = INTIAL_WEAPON_RECHARGE_INDEX;
			ship_p->weapon_recharge_index = ONE_HALF_INDEX;
			ship_p->engine_recharge_index = ONE_HALF_INDEX;
			break;
