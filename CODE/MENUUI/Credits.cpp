 ...
 *
 * $Log: /Freespace2/code/MenuUI/Credits.cpp $
 * 
...
/*	{
	...
	{
			credits_screen_buttons("CRB_04", 571, 425, 450, 413, 4),	// GR_640
...
float Credit_stop_pos, Credit_position = 0.0f;
float Credit_start_pos = 400.0f;
...
void credits_init()
{
	...
	Credit_start_pos = 0;//i2fl(Credits_text_coords[gr_screen.res][CREDITS_H_COORD]);
	...
	Ui_window.add_XSTR("Press Esc to Quit", -1, Buttons[EXIT_BUTTON][gr_screen.res].xt,  Buttons[EXIT_BUTTON][gr_screen.res].yt, &Buttons[EXIT_BUTTON][gr_screen.res].button, UI_XSTR_COLOR_PINK);
...
///		gr_glide_string_hack(0x8000, sy, Credit_text);
	...
	gr_string(588, 413, "Press Esc to Quit");
