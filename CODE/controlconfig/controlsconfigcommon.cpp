 ...
 *
 * $Log: controlsconfigcommon.cpp,v $
 * Revision 1.1.1.1  2004/08/13 22:47:40  Spearhawk
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 20:12:30  Darkhill
 * no message
 *
...
config_item Control_config[CCFG_MAX + 1] = {
	// targeting a ship (done)
	{                           KEY_T,				-1, TARGET_TAB,	"Target Next Ship" },
	{                           KEY_Y,				-1, TARGET_TAB,	"Target Previous Ship" },
	{             KEY_SHIFTED | KEY_T,				2,  TARGET_TAB,	"Target Next Closest Hostile Ship" },
	{             KEY_SHIFTED | KEY_Y,				-1, TARGET_TAB,	"Target Previous Closest Hostile Ship" },
	{ KEY_ALTED |               KEY_T,				-1, TARGET_TAB,	"Toggle Auto Targeting" },
	{                           KEY_F,				-1, TARGET_TAB,	"Target Next Closest Friendly Ship" },
	{             KEY_SHIFTED | KEY_F,				-1, TARGET_TAB,	"Target Previous Closest Friendly Ship" },
	{               KEY_ALTED | KEY_1,				4,  TARGET_TAB,	"Target Ship in Reticle" },
	{                           KEY_A,				-1, TARGET_TAB,	"Target Target's Nearest Attacker" },
	{ 			    KEY_P,				-1, TARGET_TAB,	"Target Last Ship to Send Transmission" },
	{ KEY_ALTED |               KEY_Y,				-1, TARGET_TAB,	"Turn Off Auto-Targeting" },

	// targeting a ship's subsystem (done)
	{               KEY_ALTED | KEY_3,				-1, TARGET_TAB,	"Target Subsystem in Reticle" },
	{                           KEY_COMMA,				-1, TARGET_TAB,	"Target Next Subsystem" },
	{               KEY_ALTED | KEY_COMMA,				-1, TARGET_TAB,	"Target Previous Subsystem" },
	{                           KEY_G,				-1, TARGET_TAB,	"Turn Off Auto-Targeting of Subsystems" },

	// matching speed (done)
	{                           KEY_ENTER,				-1, COMPUTER_TAB,	"Match Target Speed" },
	{ KEY_ALTED |               KEY_ENTER,				-1, COMPUTER_TAB,	"Toggle Auto Speed Matching" },

	// weapons (done)
	{               KEY_ALTED | KEY_8,		0, WEAPON_TAB,		"Fire Primary Weapon", CC_TYPE_CONTINUOUS },
	{							KEY_0,		1,  WEAPON_TAB,		"Fire Secondary Weapon", CC_TYPE_CONTINUOUS },
	{							KEY_X,		-1, WEAPON_TAB,		"Cycle Forward Primary Weapon" },
	{               KEY_ALTED | KEY_X,		-1, WEAPON_TAB,		"Cycle Backward Primary Weapon" },
	{				  KEY_8,						-1, WEAPON_TAB,		"Cycle Cannon Link Mode" },
	{				KEY_SHIFTED | KEY_9,		-1, WEAPON_TAB,		"Cycle Secondary Weapon Bank" },
	{               KEY_ALTED | KEY_9,		-1, WEAPON_TAB,		"Cycle Secondary Weapon Firing Rate" },
	{                           KEY_C,		3, WEAPON_TAB,		"Launch Countermeasure" },
	{                           KEY_TAB,			-1, WEAPON_TAB,		"Use P.O.D."},
	
	// controls (done)
	{                           KEY_LCTRL,			-1, SHIP_TAB,		"Reverse Thrust", CC_TYPE_CONTINUOUS },
	...
	// throttle controls (done)
	{                           KEY_SLASH,			-1, SHIP_TAB,		"Set Throttle to Zero" },
	{                           KEY_BACKSP,			-1, SHIP_TAB,		"Set Throttle to Max" },
	...
	// squadmate messaging (done)
	{             KEY_SHIFTED | KEY_A,				-1, COMPUTER_TAB,	"Attack My Target" },
	{             KEY_SHIFTED | KEY_Z,				-1, COMPUTER_TAB,	"Disarm My Target" },
	{             KEY_SHIFTED | KEY_X,				-1, COMPUTER_TAB,	"Disable My Target" },
	{             KEY_SHIFTED | KEY_V,				-1, COMPUTER_TAB,	"Attack my Subsystem" },
	{             KEY_SHIFTED | KEY_D,				-1, COMPUTER_TAB,	"Capture My Target" },
	{             KEY_SHIFTED | KEY_G,				-1, COMPUTER_TAB,	"Engage Enemy" },
	...
	{             KEY_SHIFTED | KEY_H,				-1, COMPUTER_TAB,	"Return to base" },
	{	      KEY_SHIFTED | KEY_B,				-1, COMPUTER_TAB, 	"Rearm me" },

	{			    KEY_R,				6,  TARGET_TAB,		"Target Closest Attacking Ship" },

	// Views (done)
	{               KEY_ALTED | KEY_J,			-1, COMPUTER_TAB,	"Chase View" },
	{                           KEY_PADDIVIDE,		-1, COMPUTER_TAB,	"External View"},
	{                           KEY_PADENTER,		-1, COMPUTER_TAB,	"Toggle External Camera Lock"},
	{                           KEY_PADMULTIPLY,		-1, COMPUTER_TAB,	"Free Look View", CC_TYPE_CONTINUOUS },
	{               KEY_ALTED | KEY_U,			-1, COMPUTER_TAB,	"Current Target View" },
	...
	// Computer (done)
	{                           KEY_LAPOSTRO,		-1, COMPUTER_TAB,	"Cycle Radar Range" },
	{                           KEY_5,			-1, COMPUTER_TAB, "Communications Menu" },
	{                           -1,				-1, -1,				"Show Objectives" },
	{                           KEY_H,			-1, COMPUTER_TAB,	"Enter Hyperspace (End Mission)" },
	{                           KEY_J,			-1, TARGET_TAB,	"Target Target's Target" },
	//{                           KEY_N,			5,  SHIP_TAB,		"Afterburner", CC_TYPE_CONTINUOUS},
	...
	// Shields (done)
	{                           KEY_S,			7,  COMPUTER_TAB,	"Equalize Shield" },
	...
	{                           KEY_RAPOSTRO,		-1, COMPUTER_TAB,	"Transfer Energy Laser->Shield" },
	{                           KEY_SEMICOL,		-1, COMPUTER_TAB,	"Transfer Energy Shield->Laser" },
	{                           -1,					-1, -1,				"Show Damage Popup Window" },	
 
	// more targeting a ship (done)
	...
	{                           KEY_I,				-1, TARGET_TAB,		"Target Next Uninspected Cargo" },
	{               KEY_ALTED | KEY_I,				-1, TARGET_TAB,		"Target Previous Uninspected Cargo" },
	{						    KEY_U,				-1, TARGET_TAB,		"Target Newest Ship In Area" },
	...
	{               KEY_ALTED | KEY_B,				-1, TARGET_TAB,		"Target Previous Hostile Bomb or Bomber" },
	...
	{ KEY_ALTED	|					 KEY_PADPLUS,			-1, COMPUTER_TAB, "(Multiplayer) Observer zoom to target"},	
	...
	{                 KEY_SPACEBAR,					-1, COMPUTER_TAB,		"Enter Hangar (End Mission)"},
	//{				  -1,							-1, WEAPON_TAB,		"Cycle Missile Link Mode"},
	{                 KEY_V,						-1, SHIP_TAB,		"Open/Close S-Foils" },
	{                 -1,							-1, -1,				"" },
};
