...
// normal text
#define Color_text_normal			Color_bright_white
...
#define Color_normal Color_bright_white
...
extern color Color_orange, Color_bright_orange, Color_purple, Color_bright_purple, Color_medium_blue;
