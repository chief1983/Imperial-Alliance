...
color Color_orange, Color_bright_orange, Color_purple, Color_bright_purple, Color_medium_blue;
...
void alpha_colors_init()
{
	...
	gr_init_alphacolor( &Color_orange, 255, 128, 0, 255 );
	gr_init_alphacolor( &Color_bright_orange, 255, 176, 98, 255 );
	gr_init_alphacolor( &Color_purple, 64, 0, 128, 255 );
	gr_init_alphacolor( &Color_bright_purple, 112, 0, 223, 255 );

	gr_init_alphacolor (&Color_medium_blue, 139, 139, 192, 255);
}
