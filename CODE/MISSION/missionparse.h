...
/*
 * $Source: C:/Program/cvsnt/cvsrepo/imperialalliance/CODE/MISSION/missionparse.h,v $
 * $Revision: 1.1.1.1 $
 * $Author: Spearhawk $
 ...
 *
 * $Log: missionparse.h,v $
 * Revision 1.1.1.1  2004/08/13 22:47:42  Spearhawk
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 21:52:12  Darkhill
 * no message
 *
...
// mission file format!
#define	MISSION_VERSION 1.00f
#define	FRED_MISSION_VERSION 1.00f
...
typedef struct support_ship_info {
	...
	int		jump_anchor;					// what hyper buoy to use
...
typedef struct p_object {
	...
	int pod_weapon;							// pod weapon to be used on this particular craft
	int sfoil_status;						// open/closed at start of mission
...
#define P2_SF2_SHIP_HAS_JAMMER			(1 << 2)
#define P2_SF2_SFOILS_OPEN				(1 << 3)
...
#else 
	#define MAX_SHIP_ARRIVALS		200			// maximum of 90 objects can arrive later
	#define MAX_WING_ARRIVALS		50			// maximum of 20 wings can arrive later
#endif
