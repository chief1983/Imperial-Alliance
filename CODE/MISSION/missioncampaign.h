 ...
 *
 * $Log: missioncampaign.h,v $
 * Revision 1.1.1.1  2004/08/13 22:47:41  Spearhawk
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 21:49:38  Darkhill
 * no message
 *
...
#else
	#define BUILTIN_CAMPAIGN		"ImperialAlliance"
	#define BUILTIN_CAMPAIGN_NAME	"The Main Imperial Alliance Campaign"
#endif
