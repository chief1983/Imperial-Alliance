 ...
 *
 * $Log: cfilearchiver.cpp,v $
 * Revision 1.1.1.1  2004/08/13 22:47:40  Spearhawk
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 20:07:00  Darkhill
 * no message
 *
...
// search for vp_file_header for struct in game code
