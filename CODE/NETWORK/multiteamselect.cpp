 ...
 * $Revision: 1.2 $
 * $Date: 2004/09/07 22:56:37 $
 * $Author: Darkhill $
 *
 * Multiplayer Team Selection Code
 *
 * $Log: multiteamselect.cpp,v $
 * Revision 1.2  2004/09/07 22:56:37  Darkhill
 ...
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 21:26:09  Darkhill
 * no message
 *
...
ui_button_info Multi_ts_buttons[GR_NUM_RESOLUTIONS][MULTI_TS_NUM_BUTTONS] = {
	{ // GR_640
		ui_button_info("CB_00",		485,375,		37,	7,		0),
		ui_button_info("CB_01",		485,320,	37,	23,	1),
		ui_button_info("CB_02",		540,320,	37,	39,	2),
		ui_button_info("TSB_03",	60,275,	-1,	-1,	3),
		ui_button_info("TSB_04",	60,421,	-1,	-1,	4),
		ui_button_info("TSB_09",	540,375,	572,	413,	9),
		ui_button_info("TSB_34",	540,215,	543, 236,	34)
	},
	{ // GR_1024
...
#define NUM_TS_TEXT 7

UI_XSTR Multi_ts_text[GR_NUM_RESOLUTIONS][NUM_TS_TEXT] = {
		{ // GR_640
			{ "Briefing",	-1,		485,	397,	UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[0][MULTI_TS_BRIEFING].button },
			{ "Ships",		-1,		493,	342,	UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[0][MULTI_TS_SHIP_SELECT].button },
			{ "Weapons",	-1,		537,	342,	UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[0][MULTI_TS_WEAPON_SELECT].button },
			{ "",			-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[0][MULTI_TS_SHIPS_UP].button },
			{ "",			-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[0][MULTI_TS_SHIPS_DOWN].button },
			{ "Commit",		-1,		541,	397,	UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[0][MULTI_TS_COMMIT].button },
			{ "Unlock",		-1,		542,	236,		UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[0][MULTI_TS_LOCK].button },
		},
		{ // GR_1024
			{ "Briefing",	-1,		485,	397,	UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[1][MULTI_TS_BRIEFING].button },
			{ "Ships",		-1,		493,	342,	UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[1][MULTI_TS_SHIP_SELECT].button },
			{ "Weapons",	-1,		540,	342,	UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[1][MULTI_TS_WEAPON_SELECT].button },
			{ "",			-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[1][MULTI_TS_SHIPS_UP].button },
			{ "",			-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[1][MULTI_TS_SHIPS_DOWN].button },
			{ "Commit",		-1,		541,	397,	UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[1][MULTI_TS_COMMIT].button },
			{ "Unlock",		-1,		-1,		-1,		UI_XSTR_COLOR_GREEN, -1, &Multi_ts_buttons[1][MULTI_TS_LOCK].button },
		}
};

void team_select_maybe_show_button_text();
...
char *Multi_ts_slot_names[MULTI_TS_NUM_SHIP_SLOTS] = {									// 
	...
	"Thisissuchalongplaceholderstring 1", "Thisissuchalongplaceholderstring 2", "Thisissuchalongplaceholderstring 3", "Thisissuchalongplaceholderstring 4",
	"Thisissuchalongplaceholderstring 1", "Thisissuchalongplaceholderstring 2", "Thisissuchalongplaceholderstring 3", "Thisissuchalongplaceholderstring 4",
	"Thisissuchalongplaceholderstring 1", "Thisissuchalongplaceholderstring 2", "Thisissuchalongplaceholderstring 3", "Thisissuchalongplaceholderstring 4"
};
...
static int Multi_ts_slot_icon_coords[MULTI_TS_NUM_SHIP_SLOTS][GR_NUM_RESOLUTIONS][2] = {							// x,y
	{		// 	
			{152,309},		// GR_640 {128,301}
			{205,482}		// GR_1024
	},
	{		// 
			{123,355},		// GR_640 {91,347}
			{146,555}		// GR_1024
	},
	{		// 
			{181,355},		// GR_640  {166,347}
			{266,555}		// GR_1024
	},
	{		// alpha
			{152,401},		// GR_640 {128,395}
			{205,632}		// GR_1024
	},
	{		//  
			{277,309},		// GR_640 {290,301}
			{464,482}		// GR_1024
	},
	{		// 
			{248,355},		// GR_640 {253,347}
			{405,555}		// GR_1024
	},
	{		// 
			{306,355},		// GR_640 {328,347}
			{525,555}		// GR_1024
	},
	{		// beta
			{277,401},		// GR_640 {290,395}
			{464,632}		// GR_1024
	},
	{		// 
			{402,309},		// GR_640 {453,301}
			{725,482}		// GR_1024
	},
	{		// 
			{373,355},		// GR_640 {416,347}
			{666,555}		// GR_1024
	},
	{		//
			{431,355},		// GR_640 {491,347}
			{786,555}		// GR_1024
	},
	{		// gamma
			{402,401},		// GR_640 {453,395}
			{725,632}		// GR_1024
	}
};
...
static int Multi_ts_slot_text_coords[MULTI_TS_NUM_SHIP_SLOTS][GR_NUM_RESOLUTIONS][3] = {	// x,y,width
	{		// alpha 1
		{142,338,56},	// GR_640 {112,330,181-112},
		{187,517,181-112}		// GR_1024
	},
	{		// alpha 2
		{113,384,56},	// GR_640 {74,377,143-74}
		{126,592,143-74}	// GR_1024
	},
	{		// alpha 3
		{171,384,56},// GR_640 {149,377,218-149}
		{248,592,218-149}	// GR_1024
	},
	{		// alpha 4
		{142,430,56},// GR_640 {112,424,181-112}
		{187,667,181-112}	// GR_1024
	},
	{		// beta 1
		{267,338,56},// GR_640 {274,330,343-274}
		{446,517,343-274}	// GR_1024
	},
	{		// beta 2
		{238,384,56},// GR_640 {236,377,305-236}
		{385,592,305-236}	// GR_1024
	},
	{		// beta 3
		{296,384,56},// GR_640 {311,377,380-311}
		{507,592,380-311}	// GR_1024
	},
	{		// beta 4
		{267,430,56},// GR_640 {274,424,343-274}
		{446,667,343-274}	// GR_1024
	},
	{		// gamma 1
		{392,338,56},// GR_640 {437,330,506-437}
		{707,517,506-437}	// GR_1024
	},
	{		// gamma 2
		{363,384,56},// GR_640 {399,377,468-399}
		{646,592,468-399}	// GR_1024
	},
	{		// gamma 3
		{421,384,56},// GR_640 {474,377,543-474}
		{768,592,543-474}	// GR_1024
	},
	{		// gamma 4
		{392,430,56},// GR_640 {437,424,506-437}
...
static int Multi_ts_avail_coords[MULTI_TS_AVAIL_MAX_DISPLAY][GR_NUM_RESOLUTIONS][2] = {							// x,y coords
	{		// 
			{59,299},	// GR_640 {23,331}
			{37,530}		// GR_1024
	},
	{		// 
			{59,329},	// GR_640 {23,361}
			{37,578}		// GR_1024
	},
	{		// 
			{59,359},	// GR_640 {23,391}
			{37,626}		// GR_1024
	},
	{		//
			{59,389},	// GR_640 {23,421}
			{37,674}		// GR_1024
	}
};
...
void team_select_force_button_frame(int n);
...
{	
	...
	if(multi_ts_is_locked())
		Multi_ts_buttons[gr_screen.res][MULTI_TS_LOCK].button.draw_forced(1);
	else 
	...
	for (int x=0; x<3; x++)
		team_select_force_button_frame(x);
	...
	//	team_select_force_button_frame(6);

	team_select_maybe_show_button_text();
...
void multi_ts_assign_players_all()
{
	...
	if(Netgame.type_flags & NG_TYPE_TEAM){
		...
		case 0 :
			strcpy(name_lookup, Multi_ts_slot_team_names[0][0]);
			break;
		case 1 :
			strcpy(name_lookup, Multi_ts_slot_team_names[1][0]);
			break;
		}
	} else {
		strcpy(name_lookup, Multi_ts_slot_names[0]);
	}
	//fprintf(fp, "%s %s", Multi_ts_slot_team_names[0][0], Multi_ts_slot_team_names[1][0]);
	//fclose(fp);
...
void multi_ts_blit_wing_callsigns()
{
	...
	for(idx=0;idx<MAX_WSS_SLOTS;idx++){		
		...
		gr_string(Multi_ts_slot_text_coords[idx][gr_screen.res][MULTI_TS_X_COORD] + ((Multi_ts_slot_text_coords[idx][gr_screen.res][MULTI_TS_W_COORD] - callsign_w)/2) -1 ,Multi_ts_slot_text_coords[idx][gr_screen.res][MULTI_TS_Y_COORD],callsign);								
	}	
}
...
{					
	...
	if(!Multi_ts_team[Net_player->p_info.team].multi_players_locked){
		if(multi_num_players() != 1){
			popup(PF_USE_AFFIRMATIVE_ICON | PF_BODY_BIG,1,POPUP_OK,XSTR("Ships/weapons must be unlocked before continuing.",-1));
			return;
		} else {
			Multi_ts_team[Net_player->p_info.team].multi_players_locked = 1;
		}
...
int multi_ts_ok_to_commit()
{
	...
	for(idx=0;idx<MULTI_TS_NUM_SHIP_SLOTS;idx++){
		...
		if( (Multi_ts_team[Net_player->p_info.team].multi_ts_objnum[idx] != -1) && 
			...
			// we don't check for a craft not having secondaries for ships like standard TIEs
...
void team_select_force_button_frame(int n)
{
	if ( !Multi_ts_buttons[gr_screen.res][n].button.button_down() ) {
		Multi_ts_buttons[gr_screen.res][n].button.draw_forced(1);
	}
}
...
void team_select_maybe_show_button_text()
{
	...
	for (int i=0; i<NUM_TS_TEXT; i++) {
		b = &Multi_ts_buttons[gr_screen.res][i];

		if (b->button.button_hilighted()) {
			gr_set_color_fast(&Color_bright_white);
			gr_string(Multi_ts_text[gr_screen.res][i].x, Multi_ts_text[gr_screen.res][i].y, Multi_ts_text[gr_screen.res][i].xstr);
		}
	}
}
