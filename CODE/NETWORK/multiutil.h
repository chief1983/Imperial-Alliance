 ...
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 21:26:53  Darkhill
 * no message
 *
...
// server should update player's s-foil status on given ship
void multi_server_update_player_sfoils(net_player *pf, ship *shipp);
