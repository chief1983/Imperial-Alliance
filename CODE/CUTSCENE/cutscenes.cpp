 ...
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 20:12:36  Darkhill
 * no message
 *
...
void cutscenes_force_button_frame();
void cutscenes_maybe_show_button_text();
...
static ui_button_info Buttons[GR_NUM_RESOLUTIONS][NUM_BUTTONS] = {
	{ // GR_640
		ui_button_info("TDB_00",	45,		375,		37,	7,		0),			// tech database 1
		ui_button_info("TDB_01",	155,	375,	37,	23,	1),			// tech database 2
		ui_button_info("TDB_02",	100,	375,	37,	38,	2),			// tech database 3
		ui_button_info("TDB_03",	540,	375,	37,	54,	3),			// tech database 4

		ui_button_info("VFB_04",	72,		600,	-1,	-1,	4),			// scroll up
		ui_button_info("VFB_05",	248,	600,	-1,	-1,	5),			// scroll down
		ui_button_info("VFB_06",	160,	600,	587,	366,	6),			// play
		ui_button_info("VFB_07",	864,	600,	587,	413,	7),			// exit
	},
	{ // GR_1024
...
// text
#define NUM_CUTSCENE_TEXT			4
UI_XSTR Cutscene_text[GR_NUM_RESOLUTIONS][NUM_CUTSCENE_TEXT] = {//167 111 57
	{ // GR_640
//		{"",		1055,		37,	7,		UI_XSTR_COLOR_GREEN, -1, &Buttons[0][TECH_DATABASE_BUTTON].button },
//		{"",		1056,		37,	23,	UI_XSTR_COLOR_GREEN, -1, &Buttons[0][SIMULATOR_BUTTON].button },
	//	{"",					1057,		37,	38,	UI_XSTR_COLOR_GREEN, -1, &Buttons[0][CUTSCENES_BUTTON].button },
	//	{"",						1058,		37,	54,	UI_XSTR_COLOR_GREEN, -1, &Buttons[0][CREDITS_BUTTON].button },
		{"Prev",							-1,		57,	395,	UI_XSTR_COLOR_GREEN, -1, &Buttons[0][SCROLL_UP_BUTTON].button },
		{"Next",							-1,		167,	395,	UI_XSTR_COLOR_GREEN, -1, &Buttons[0][SCROLL_DOWN_BUTTON].button },
		{"Play",							1335,	111,	395,	UI_XSTR_COLOR_GREEN, -1, &Buttons[0][PLAY_BUTTON].button },
		{"Exit",							1419,	554, 395,	UI_XSTR_COLOR_PINK, -1, &Buttons[0][EXIT_BUTTON].button },			
	},
	{ // GR_1024
	//	{"",		1055,		59,	12,	UI_XSTR_COLOR_GREEN, -1, &Buttons[1][TECH_DATABASE_BUTTON].button },
	//	{"",		1056,		59,	37,	UI_XSTR_COLOR_GREEN, -1, &Buttons[1][SIMULATOR_BUTTON].button },
	//	{"",					1057,		59,	62,	UI_XSTR_COLOR_GREEN, -1, &Buttons[1][CUTSCENES_BUTTON].button },
	//	{"",						1058,		59,	88,	UI_XSTR_COLOR_GREEN, -1, &Buttons[1][CREDITS_BUTTON].button },
		{"Next",							1335,		587,	366,	UI_XSTR_COLOR_GREEN, -1, &Buttons[0][SCROLL_UP_BUTTON].button },
		{"Prev",							1335,		587,	366,	UI_XSTR_COLOR_GREEN, -1, &Buttons[0][SCROLL_DOWN_BUTTON].button },
...
/*	for (i=TECH_DATABASE_BUTTON; i<=CREDITS_BUTTON; i++){
	...
	cutscenes_force_button_frame();
	cutscenes_maybe_show_button_text();
...
//ui_button_info Buttons
//Cutscene_text
void cutscenes_maybe_show_button_text()
{
	ui_button_info *b;
	
	// don't worry about first four buttons in list
	for (int i=4; i<NUM_BUTTONS; i++) {
		b = &Buttons[gr_screen.res][i];

		if (b->button.button_hilighted()) {
			gr_set_color_fast(&Color_bright_white);
			gr_string(Cutscene_text[gr_screen.res][i-4].x, Cutscene_text[gr_screen.res][i-4].y, Cutscene_text[gr_screen.res][i-4].xstr);
		}
	}
}
