 ...
 *
 * $Log: gamesequence.h,v $
 * Revision 1.1.1.1  2004/08/13 22:47:40  Spearhawk
 * no message
 *
 * Revision 1.1.1.1  2004/08/13 20:57:08  Darkhill
 * no message
 *
...
#define GS_EVENT_PILOT_INFO						64		// view stats about current pilot
#define GS_EVENT_PILOT_MANAGE					65		// view details about all pilots
...
#define GS_STATE_PILOT_INFO						51				                                                       							
#define GS_STATE_PILOT_MANAGE					52
